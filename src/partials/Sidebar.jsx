      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Dashboard */}
              <li  className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))]  ${pathname === "/" || pathname.includes("dashboard") ? "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]" : "hover:text-gray-900 dark:hover:text-white"}`}>
                <NavLink
                  end
                  to="/admin/dashboard"
              ...
              {/* lessons */}
              <SidebarLinkGroup activecondition={pathname.includes("lessons")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Analytics */}
              <SidebarLinkGroup activecondition={pathname.includes("analytics")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
